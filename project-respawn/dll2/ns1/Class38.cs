...
namespace ns1
{
	[DebuggerDisplay("\\{ Object = {Object}, Value = {Value} }", Type = "<Anonymous Type>"), CompilerGenerated]
	internal sealed class Class38<T, U>
	{
		...
		[DebuggerHidden]
		public Class38(T gparam_2, U gparam_3)
		{
		...
		{
			Class38<T, U> @class = value as Class38<T, U>;
		...
		{
			int num =  EqualityComparer<T>.Default.GetHashCode(this.gparam_0);
