...
namespace ns0
{
	internal sealed class Class37
	{
		...
		static Class37()
		{
			Class37.int_0 = 2147483647;
			Class37.int_1 = -2147483648;
			Class37.memoryStream_0 = null;
			Class37.memoryStream_1 = null;
			Class37.object_0 = new object();
		}
		...
		{
			object obj;
			Monitor.Enter(obj = Class37.object_0);
			byte[] result;
			try
			{
				...
				if ((b & 1) != 0)
				{
					...
					for (int i = 0; i < array3.Length; i++)
					{
						if (array3[i] != 0)
						{
							...
							if (flag)
							{
								array2 = Class37.smethod_1(Assembly.GetExecutingAssembly());
							}
							dESCryptoServiceProvider.Key = array2;
							if (Class37.memoryStream_0 == null)
							{
								if (Class37.int_0 == 2147483647)
								{
									Class37.memoryStream_0 = new MemoryStream((int)stream_0.Length);
								}
								else
								{
									Class37.memoryStream_0 = new MemoryStream(Class37.int_0);
								}
							}
							Class37.memoryStream_0.Position = 0L;
							...
							while ((long)(num + inputBlockSize) < stream_0.Length)
							{
								...
								Class37.memoryStream_0.Write(array4, 0, count);
								num += inputBlockSize;
							}
							...
							Class37.memoryStream_0.Write(array6, 0, array6.Length);
							stream = Class37.memoryStream_0;
							stream.Position = 0L;
							memoryStream = Class37.memoryStream_0;
							goto IL_1AA;
						}
					}
				...
				if ((b & 2) != 0)
				{
					try
					{
						if (Class37.memoryStream_1 == null)
						{
							if (Class37.int_1 == -2147483648)
							{
								Class37.memoryStream_1 = new MemoryStream((int)stream.Length * 2);
							}
							else
							{
								Class37.memoryStream_1 = new MemoryStream(Class37.int_1);
							}
						}
						Class37.memoryStream_1.Position = 0L;
						...
						do
						{
							...
							if (num3 > 0)
							{
								Class37.memoryStream_1.Write(buffer, 0, num3);
							}
						}
						while (num3 >= num2);
						memoryStream = Class37.memoryStream_1;
					}
					catch (Exception)
					{
					}
