...
namespace ns0
{
	internal sealed class Class37
	{
		...
		public Class37(int int_1 = 20, double double_2 = 1.0)
		{
			if (double_2 < 1.0)
			{
		...
		private void method_0()
		{
			...
			{
				double num4 = this.double_0[j];
				num4 *= num3;
				num4 -= 1.0;
				num4 *= this.double_1;
				this.double_0[j] = num4;
			}
			num = 0.0;
			double num5 = 0.0;
			double num6 = 0.0;
			...
			{
				if (this.double_0[k] < num5)
				{
					num5 = this.double_0[k];
				}
				if (this.double_0[k] > num6)
				{
					num6 = this.double_0[k];
				}
				num += this.double_0[k];
			}
